...
Al utilizar un servicio en línea, los datos de ingreso del workflow pueden variar durante las ejecuciones, por lo tanto la metodología de la verificación fue la revisión de la estructura de los resultados, el tamaño de los archivos, número de líneas y la inexistencia de errores.
...
Todas las imágenes son publicadas con su correspondiente Dockerfile y cualquier usuario puede inspeccionarlas y mejorarlas. 
Las imágenes puede ser encontradas en DockerHub \footnote{https://hub.docker.com/u/dockerpedia/}\cite{xcorr-image,internal-image,soykb-image,montage-image,wings-image}  y GitHub \footnote{\url{https://github.com/dockerpedia}} \cite{xcorr-results,internal-results,soykb-results,montage-results,wings-results}. 
...
Para obtener las anotaciones, se propone e implementa el un sistema de anotador. La figura \ref{fig:arch} muestra los pasos principales del sistema.
...
\begin{figure*}
\begin{lstlisting}[caption={Inspeccionar las anotaciones de la imagen.},label={lst:inspect_result},language=json]
{
"maintainer": "Maximiliano Osorio <mosorio@inf.utfsm.cl>",
"org.opencontainers.image.created": "2018-11-10T21:11:28Z",
"org.opencontainers.image.title": "Soybean Knowledge Base",
"org.opencontainers.image.url": "http://www.soykb.org/",
"org.opencontainers.image.revision": "15955b0",
"org.opencontainers.image.source": "https://github.com/dockerpedia/soykb",
"org.opencontainers.image.vendor": "DockerPedia",
...
Por ejemplo, en agosto de 2018, se construyó la imagen del workflow SoyKB, y se pudo ejecutar el workflow con éxito. Sin embargo, en noviembre se reconstruyó una nueva imagen utilizando el mismo DeploymentPlan y no se pudo ejecutar el workflow con éxito.
...
En el siguiente capítulo se muestra las conclusiones y trabajo futuro del trabajo.