...
Es requisito que los materiales deben incluir los datos de ingresos\todo[inline]{?? no entiendo} que permitan reproducir de forma completa el workflow, documentación, resultados o anotaciones. Además deben permitir comparar los resultados de nuestro ambientes resultantes.
